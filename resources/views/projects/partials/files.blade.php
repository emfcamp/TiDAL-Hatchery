<table class="table table-striped">
    ...
    @forelse($project->versions->last()->files()->paginate() as $file)
		...
		@can('delete', $file)
                ...
                <button class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target="#confirm-delete" name="delete-resource" type="submit" value="delete"  style="width: 48px;">delete</button>
		        {!! Form::close() !!}
		@endcan
            </td>
        </tr>
